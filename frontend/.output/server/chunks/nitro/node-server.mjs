...
const _runtimeConfig = (function(a){return {app:{baseURL:"\u002F",buildAssetsDir:"\u002F_nuxt\u002F",cdnURL:""},nitro:{routes:{},envPrefix:"NUXT_"},public:{GQL_HOST:a,"graphql-client":{clients:{default:{host:a,token:{type:"Bearer"}}}}},"graphql-client":{clients:{}}}}("http:\u002F\u002Flocalhost:8080\u002Fgraphql"));
...
const _b8f8df = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _33be66, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _b8f8df, lazy: true, method: undefined },
  { route: '/**', handler: _b8f8df, lazy: true, method: undefined }
];
