...
INSERT INTO users (first_name, last_name, middle_name, login, password, role_id) VALUES ('Evgeniy', 'Kruglov', 'Alekseeivch', 'zheka', '$2a$12$T5ntfXXM5.9o1TRUXabGyOhUzEMd7koA9hS31zDoJKUo07CxYTY52', 2);
INSERT INTO users (first_name, last_name, middle_name, login, password, role_id) VALUES ('Konstantin', 'Kruglov', 'Alekseeivch', 'kostya', '$2a$12$T5ntfXXM5.9o1TRUXabGyOhUzEMd7koA9hS31zDoJKUo07CxYTY52', 1);
INSERT INTO users (first_name, last_name, middle_name, login, password, role_id) VALUES ('Timofey', 'Kruglov', 'Dmitrievich', 'tima', '$2a$12$T5ntfXXM5.9o1TRUXabGyOhUzEMd7koA9hS31zDoJKUo07CxYTY52', 1);
